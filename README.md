...
.banner{
    background-image: linear-gradient(rgba(0, 0, 0, .6), rgba(49, 168, 221, .2), rgba(0, 0, 0, .6)) url(imgdio/banner.png);
    background-size: cover;
    background-repeat: no-repeat;
    height: 600px;
    padding-top: 60px;
    border-bottom: 1px solid #33A8DB80;
    background-image: url(imgdio/banner.png);
}
...
.banner .banner-content {
  ...
  #transform-world {
    height: 560px;
    background-size: cover;
    background-image: url("imgdio/woman-code.png");
